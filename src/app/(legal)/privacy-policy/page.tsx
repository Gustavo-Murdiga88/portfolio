...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    languages: {
      "pt-BR": `${process.env.NEXT_PUBLIC_SITE_URL}/privacy-policy`,
    },
  },
};
      ...
      <div className="mx-auto max-w-4xl px-4 py-8">
        ...
        <article className="space-y-8 text-zinc-200">
          ...
          <section>
            ...
            <div className="space-y-4">
              <p>
                ...
                pessoais dos usuários em conformidade com a Lei Geral de
            ...
            <div className="space-y-4">
              <div>
                ...
                <ul className="list-inside list-disc space-y-1">
                  ...
                  <li>
                    Informações voluntariamente fornecidas em comunicações
                  </li>
                </ul>
              </div>
          ...
          <section>
            ...
            <div className="space-y-4">
              <p>
                Este site usa o Google AdSense para exibir anúncios. O Google
                pode usar cookies para veicular anúncios com base nas visitas
                anteriores a este site ou outros sites.
              </p>
              <ul className="list-inside list-disc space-y-2">
                <li>
                  Os anúncios podem ser personalizados com base em seus
                  interesses
                </li>
                <li>
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <ul className="list-inside list-disc space-y-2">
                <li>
                  <strong>Acesso:</strong> Saber quais dados possuímos sobre
                  você
                </li>
                <li>
          ...
          <section>
            ...
            <p>
              ...
              . Você pode deletar todos os cookies que já estão no seu
              computador e pode configurar a maioria dos navegadores para
