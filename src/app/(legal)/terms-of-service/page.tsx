...
export const metadata: Metadata = {
  title: "Termos de Uso - Gustavo Murdiga",
  description:
    ...
    <div className="mx-auto max-w-4xl px-4 py-8">
      ...
      <article className="space-y-8 text-zinc-200">
        ...
        <section>
          ...
          <p>
            Ao acessar e usar o site gustavomurdiga.vercel.app, você concorda em
        ...
        <section>
          ...
          <div className="space-y-4">
            ...
            <p>
              Você não pode copiar, modificar, distribuir ou usar comercialmente
        ...
        <section>
          ...
          <p>
            ...
            garantimos a precisão ou adequação dos produtos/serviços anunciados.
            Você interage com anunciantes por sua própria conta e risco.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Podemos encerrar ou suspender seu acesso ao site imediatamente, sem
        ...
        <section>
          ...
          <p>
            ...
            disputa será resolvida nos tribunais competentes de Jaú, São Paulo,
            Brasil.
          </p>
        </section>
