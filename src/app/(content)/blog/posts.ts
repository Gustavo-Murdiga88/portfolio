const blogPosts = [
  ...
  },
  {
    ...
    excerpt: `Minha jornada na tecnologia começou de forma não convencional. Em 2020, iniciei o curso de Arquitetura de Dados na Anhanguera, mas foi minha primeira experiência profissional na STi3 que realmente mudou minha trajetória. Comecei lá em uma posição de suporte técnico, onde tive meu primeiro contato direto com sistemas corporativos e as necessidades reais dos usuários. Após 7 meses dedicados ao suporte técnico, consegui minha primeira transição para desenvolvimento web - um momento que mudou completamente meus horizontes profissionais. Sou eternamente grato à STi3 pela oportunidade de crescimento e pela confiança depositada em mim durante essa transição crucial. O que começou como curiosidade rapidamente se transformou em dedicação total. Passei horas estudando, praticando e construindo projetos que me permitiram entender não apenas as tecnologias, mas também como elas poderiam resolver problemas reais do mundo.`,
